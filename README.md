# Data Science | Riski Dwi Nugroho
Nama   : Riski Dwi Nugroho
...
## Petunjuk Penggunaan
### Untuk penggunaan di lokal komputer, dapat dilakukan dengan 

1. Clone repository:
```git clone https://github.com/username/nama-repository.git```
2. Install library yang dibutuhkan sesuai dengan pertemuan yang akan dijalankan:
```pip install pandas numpy matplotlib seaborn scikit-learn scipy jupyter```

### Google Colab
Untuk Penggunaan dengan Google Colab dapat dilakukan dengan mengunggah file ```.ipynb``` atau menggunakan link Colab yang tersedia pada masing-masing notebook.

# Kesimpulan
Proses hands-on dari pertemuan 1 hingga pertemuan 7 memiliki alur yang cukup runtut, mulai dari pengenalan sintaks dasar Python, melakukan pengolahan dan eksplorasi data, visualisasi data, tahap data preprocessing, hingga menggunakan model Regresi Linear untuk melakukan prediksi. Setiap pertemuan saling berkaitan dan membangun pemahaman secara bertahap
